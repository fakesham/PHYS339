...
def report(result):
    ...
    params=urllib.urlencode({"workstation":workstation,"game":"warmer_colder","resp":result})
    f = urllib.urlopen("http://132.206.252.3/339/intro.php",params)
    print f.read()
    
#
# Copy your warmer_colder games playing function here
#
